            ...
            <div class="card-body">
                <form action="{{route('event.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="date" name="event_date" id="event_date" class="form-control w-50" value="{{old('event_date')}}">
                        @error('event_date')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="mb-2">
                        ...
                        <input type="time" name="event_time" id="event_time" class="form-control w-50" value="{{old('event_time')}}">
                        @error('event_time')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <select name="country" id="country" class="form-select">
                            ...
                            @foreach ($countries as $i=>$country)
                                <option value="{{$i}}" @selected(old('country') == $i)>{{$country}}</option>
                            @endforeach
                        </select>
                        @error('country')
                            <div class="text-danger">{{$message}}</div>
                     ...
                     <div class="mb-2">
                        ...
                        <select name="organizer" id="organizer" class="form-select">
                            ...
                            @foreach ($organizers as $i=>$organizer)
                                <option value="{{$i}}" @selected(old('organizer') == $i)>{{$organizer}}</option>
                            @endforeach
                        </select>
                        @error('organizer')
                            <div class="text-danger">{{$message}}</div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" name="max_attendees" id="max_attendees" class="form-control w-50" value="{{old('max_attendees')}}">
                        @error('max_attendees')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
